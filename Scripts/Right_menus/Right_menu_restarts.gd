...
@onready var CONNECT_LINES : Dictionary = {
	"H_Master" : [$Right_menu/Main/Load_Master/Master/Master_text/Master_H],
	"H_Load" : [$Right_menu/Main/Load_Master/Master/Master_text/Load_H],
	"H_Name" : [$Right_menu/Main/Restart_name_placeholder/Name_edit/Hs_restart_name, $Right_menu/Main/Restart_name_placeholder/Name_edit/HL_restart_name],
	"V_Name" : [$Right_menu/Main/Restart_name_placeholder/Name_edit/V_restart_name],
...
@onready var BUTTONS : Dictionary = {
	"Master" : $Right_menu/Main/Load_Master/Master/Master,
	"Load" : $Right_menu/Main/Load_Master/Load/Load/Load,
	"NameHolder" : $Right_menu/Main/Restart_name_placeholder/Name_edit,
